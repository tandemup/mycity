...
const routes: Routes = [
 // { path: '', loadChildren: './tabs/tabs.module#TabsPageModule' },
  ...
  { path: 'travel-place-review/:placeId',
    loadChildren: './app-travel/travel-place-review/travel-place-review.module#TravelPlaceReviewPageModule' },
  { path: 'travel-place-detail/:placeId',
    loadChildren: './app-travel/travel-place-detail/travel-place-detail.module#TravelPlaceDetailPageModule' },
  ...
  { path: 'travel-place-review-add/:placeId',
    loadChildren: './app-travel/travel-place-review-add/travel-place-review-add.module#TravelPlaceReviewAddPageModule' },
 ...
 // { path: 'shopping-review-add/:itemId',
 //   loadChildren: './app-shopping/shopping-review-add/shopping-review-add.module#ShoppingReviewAddPageModule' },
 // { path: 'shopping-image-gallery',
  //  loadChildren: './app-shopping/shopping-image-gallery/shopping-image-gallery.module#ShoppingImageGalleryPageModule' },
 ...
 // { path: 'real-map-modal', loadChildren: './app-real/real-map-modal/real-map-modal.module#RealMapModalPageModule' },
  ...
  { path: 'food-myorder-detail/:orderId',
    loadChildren: './app-food/food-myorder-detail/food-myorder-detail.module#FoodMyorderDetailPageModule' },
  ...
  //  loadChildren: './ui-components/transparent-header/transparent-header.module#TransparentHeaderPageModule' },
